...
inline float getEntityBrightness(World& world, double ex, double ey, double ez) {
...
inline void renderEntity(Entity& entity, float pTicks, World& world, Camera& camera, Shader& entityShader,
...
inline float getFirstPersonBrightness(World& world, EntityPlayer& player) {
...
inline glm::mat4 computeViewBobMatrix(EntityPlayer& player, float partialTicks) {
...
inline void renderFirstPersonArm(GameRenderer& renderer, EntityPlayer& player, World& world, Camera& camera,
...
inline void renderThirdPersonHeldItem(EntityPlayer* player, float partialTicks, const glm::dvec3& cameraPos,
