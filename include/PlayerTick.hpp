...
inline void handleBlockBreaking(Minecraft& mc, EntityPlayer& player, World& world, float partialTicks) {
...
inline void handleBlockPlacement(Minecraft& mc, EntityPlayer& player, World& world) {
...
inline HitResult updateMouseOver(Minecraft& mc, EntityPlayer& player, World& world) {
    float reach = 5.0f;
